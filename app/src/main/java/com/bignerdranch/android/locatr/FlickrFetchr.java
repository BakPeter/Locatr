...
public class FlickrFetchr {
    ...
    private void parseItems(List<GalleryItem> items, JSONObject jsonBody)
        ...
        JSONArray photoJasonArray = photosJsonObject.getJSONArray("photo");

        for (int i = 0; i < photoJasonArray.length(); i++) {
            JSONObject photoJsonObject = photoJasonArray.getJSONObject(i);
